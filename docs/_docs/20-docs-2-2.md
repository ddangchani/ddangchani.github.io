...
minimal-mistakes/
├── _includes/
\vert     ├── author-bio.html        # bio stuff layout. pulls optional owner data from _config.yml
\vert     ├── browser-upgrade   # prompt to install a modern browser for < IE9
\vert     ├── disqus-comments   # Disqus comments script
\vert     ├── footer            # site footer
\vert     ├── head              # site head
\vert     ├── navigation        # site top navigation
\vert     ├── open-graph.html        # Twitter Cards and Open Graph meta data
\vert     └── scripts           # site scripts
├── _layouts/
\vert     ├── home.html               # homepage layout
\vert     ├── page.html               # page layout
\vert     ├── post-index.html         # post index layout
\vert     └── post.html               # single post layout
├── _posts/                      # MarkDown formatted posts
├── _sass/                       # Sass stylesheets
├── _templates/                  # used by Octopress to define YAML variables for new posts/pages
├── about/                       # sample about page
├── assets/
\vert     ├── css/                    # compiled stylesheets
\vert     ├── fonts/                  # webfonts
\vert     ├── js/
\vert     \vert    ├── _main.js            # main JavaScript file, plugin settings, etc
\vert     \vert    ├── plugins/            # scripts and jQuery plugins to combine with _main.js
\vert     \vert    ├── scripts.min.js      # concatenated and minified _main.js + plugin scripts
\vert     \vert    └── vendor/             # vendor scripts to leave alone and load as is
\vert     └── less/
...
Feature and thumbnail images are used by [Open Graph](https://developers.facebook.com/docs/opengraph/) and [Twitter Cards](https://dev.twitter.com/docs/cards) as well. If you don't assign a thumbnail the default graphic *(default-thumb.png){: .align-center}* is used. I'd suggest changing this to something more meaningful --- your logo or avatar are good options.
...
<figure>
  <img src="{{ '/assets/images/paragraph-indent.png' \vert  relative_url }}" alt="screen shot of paragraphs with default indent style set">
...
<figure>
  <img src="{{ '/assets/images/paragraph-no-indent.png' \vert  relative_url }}" alt="screen shot of paragraphs with indent style disabled">
