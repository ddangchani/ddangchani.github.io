...
\vert  filename            \vert  permalink              \vert 
\vert  --------            \vert  ---------              \vert 
\vert  _pages/about.md     \vert  `permalink: /about/`   \vert 
\vert  _pages/home.md      \vert  `permalink: /`         \vert 
\vert  _pages/contact.md   \vert  `permalink: /contact/` \vert 
