...
const postProseClassName =
  "post-prose min-w-0 rounded-[var(--radius-lg)] border border-[var(--line)] bg-[color:color-mix(in_srgb,var(--surface)_96%,white)] px-[clamp(1.2rem,3vw,2rem)] py-[clamp(1.2rem,3vw,2rem)] leading-[1.85] shadow-[var(--shadow)] max-[720px]:p-4 [&_p]:[overflow-wrap:anywhere] [&_p:first-child]:mt-0 [&_p:last-child]:mb-0 [&_h1]:mt-[2.2rem] [&_h1]:mb-4 [&_h1]:[font-family:var(--font-display),serif] [&_h1]:text-[clamp(1.85rem,7vw,3rem)] [&_h1]:leading-[1.12] [&_h1]:tracking-[-0.025em] [&_h1]:scroll-mt-24 [&_h1]:[overflow-wrap:anywhere] [&_h2]:mt-8 [&_h2]:mb-[0.85rem] [&_h2]:[font-family:var(--font-display),serif] [&_h2]:text-[clamp(1.42rem,6vw,2.2rem)] [&_h2]:leading-[1.12] [&_h2]:tracking-[-0.025em] [&_h2]:scroll-mt-24 [&_h2]:[overflow-wrap:anywhere] [&_h3]:mt-[1.6rem] [&_h3]:mb-[0.75rem] [&_h3]:[font-family:var(--font-display),serif] [&_h3]:text-[clamp(1.18rem,4.8vw,1.6rem)] [&_h3]:leading-[1.14] [&_h3]:tracking-[-0.02em] [&_h3]:scroll-mt-24 [&_h3]:[overflow-wrap:anywhere] [&_h4]:[font-family:var(--font-display),serif] [&_h4]:leading-[1.12] [&_h4]:tracking-[-0.02em] [&_h4]:scroll-mt-24 [&_h4]:[overflow-wrap:anywhere] [&_ul]:pl-5 [&_ol]:pl-5 [&_li]:[overflow-wrap:anywhere] [&_li+li]:mt-[0.35rem] [&_blockquote]:my-6 [&_blockquote]:border-l-[3px] [&_blockquote]:border-l-[color:color-mix(in_srgb,var(--accent-strong)_45%,var(--line))] [&_blockquote]:py-[0.35rem] [&_blockquote]:pl-4 [&_blockquote]:text-[var(--ink-soft)] [&_blockquote]:[overflow-wrap:anywhere] [&_hr]:my-8 [&_hr]:border-0 [&_hr]:border-t [&_hr]:border-t-[var(--line)] [&_a]:text-[var(--accent-strong)] [&_a]:underline [&_a]:decoration-[0.08em] [&_a]:[overflow-wrap:anywhere] [&_img]:mx-auto [&_img]:my-6 [&_img]:h-auto [&_img]:max-w-full [&_img]:rounded-[1.25rem] [&_pre]:max-w-full [&_pre]:overflow-x-auto [&_pre]:rounded-2xl [&_pre]:bg-[color:color-mix(in_srgb,var(--ink)_6%,white)] [&_pre]:px-[1.1rem] [&_pre]:py-4 [&_pre]:[font-family:var(--font-mono),monospace] [&_code]:[font-family:var(--font-mono),monospace] [&_:not(pre)>code]:rounded-[0.45rem] [&_:not(pre)>code]:bg-[color:color-mix(in_srgb,var(--ink)_6%,white)] [&_:not(pre)>code]:px-[0.35rem] [&_:not(pre)>code]:py-[0.15rem] [&_:not(pre)>code]:[overflow-wrap:anywhere] [&_table]:my-6 [&_table]:block [&_table]:max-w-full [&_table]:overflow-x-auto [&_table]:border-collapse [&_table]:[-webkit-overflow-scrolling:touch] [&_table]:whitespace-nowrap [&_th]:border-b [&_th]:border-b-[var(--line)] [&_th]:px-3 [&_th]:py-3 [&_th]:text-left [&_td]:border-b [&_td]:border-b-[var(--line)] [&_td]:px-3 [&_td]:py-3 [&_td]:text-left [&_.katex-display]:overflow-x-auto [&_.katex-display]:overflow-y-hidden [&_.katex-display]:py-[0.4rem]";
