...
description: >-
  Intro - Most existing work on DP-publication of location data focuses on
  single snapshot releases (Cormode et al., 2012) - To release multiple
  snapshot, user-level privacy is required - Two key aspects : Bound sensiti...
date: "2024-01-16"
tags:
...
routeSegments:
  - VDR
teaser: >-
  /assets/img/%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7%202024-01-14%20%EC%98%A4%ED%9B%84%202.30.54.png
coverImage: >-
  /assets/img/%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7%202024-01-14%20%EC%98%A4%ED%9B%84%202.30.54.png
excerpt: >-
  Intro - Most existing work on DP-publication of location data focuses on
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/VDR/
---
