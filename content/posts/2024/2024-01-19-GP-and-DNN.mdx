...
description: >-
  Gaussian Process and Neural Networks 신경망 구조는 일반적으로 Universal Approximation
  Theorem에 의해 비선형 함수를 근사하는데 효과적으로 이용된다. 이러한 특성을 이용하면, 다음과 같이 신경망의 구조적 특징과 가우시안
  프로세스의 비모수적 유연성 nonparametric flexibility 을 결합한 커널을 구성할 수도 있다. $$...
date: "2024-01-19"
tags:
  - Gaussian Process
  - Deep Learning
...
routeSegments:
  - GP-and-DNN
teaser: /assets/img/Pasted%20image%2020240119124830.png
coverImage: /assets/img/Pasted%20image%2020240119124830.png
excerpt: >-
  Gaussian Process and Neural Networks 신경망 구조는 일반적으로 Universal Approximation
  Theorem에 의해 비선형 함수를 근사하는데 효과적으로 이용된다. 이러한 특성을 이용하면, 다음과 같이 신경망의 구조적 특징과 가우시안
  프로세스의 비모수적 유연성 nonparametric flexibility 을 결합한 커널을 구성할 수도 있다. $$...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/GP-and-DNN/
---

# Gaussian Process and Neural Networks

신경망 구조는 일반적으로 [Universal Approximation Theorem](/Universal-Approximation-Theorem/)에 의해 비선형 함수를 근사하는데 효과적으로 이용된다. 이러한 특성을 이용하면, 다음과 같이 신경망의 구조적 특징과 가우시안 프로세스의 비모수적 유연성<sup>nonparametric flexibility</sup>을 결합한 커널을 구성할 수도 있다.
...
![](/assets/img/Pasted%20image%2020240119124830.png)
