...
title: Transformer
description: >-
  Transformer (Updated on 2024-04-12) 트랜스포머 Transformer 는 자연어 처리 분야에서 최근 주를 이루고
  있는 딥러닝 모델이다. 이전까지는 LSTM 등의 순환신경망을 주로 이용했지만, sequence-to-sequence function
  approximation에서 대형 트랜스포머들이 좋은 성능을 보이는 것이 알려지며 주요 모델로 자리잡게 되었다. 트랜...
date: "2024-04-12"
tags:
  - Deep Learning
  - NLP
...
routeSegments:
  - Transformer
teaser: /assets/img/Pasted%20image%2020240115181859.png
coverImage: /assets/img/Pasted%20image%2020240115181859.png
excerpt: >-
  Transformer (Updated on 2024-04-12) 트랜스포머 Transformer 는 자연어 처리 분야에서 최근 주를 이루고
  있는 딥러닝 모델이다. 이전까지는 LSTM 등의 순환신경망을 주로 이용했지만, sequence-to-sequence function
  approximation에서 대형 트랜스포머들이 좋은 성능을 보이는 것이 알려지며 주요 모델로 자리잡게 되었다. 트랜...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/Transformer/
---
...
![](/assets/img/Pasted%20image%2020240115181859.png)
...
![](/assets/img/Pasted%20image%2020240115182826.png)
