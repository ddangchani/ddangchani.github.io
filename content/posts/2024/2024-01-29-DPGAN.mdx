...
description: >-
  Introduction - Propose a differentially private generative adversarial network
  - Uses the Wasserstein distance which is better than JS-divergence, i.e. WGAN
  Framework - GAN : minimax game between generator and discrim...
date: "2024-01-29"
tags:
  - Paper Review
  - Deep Learning
...
routeSegments:
  - DPGAN
teaser: /assets/img/Pasted%20image%2020240126172108.png
coverImage: /assets/img/Pasted%20image%2020240126172108.png
excerpt: >-
  Introduction - Propose a differentially private generative adversarial network
  - Uses the Wasserstein distance which is better than JS-divergence, i.e. WGAN
  Framework - GAN : minimax game between generator and discrim...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/DPGAN/
---
...
## Framework
- [GAN](/GAN/) : minimax game between generator and discriminator.
...
- Based on the [Wasserstein GAN](/Wasserstein-GAN/) (Arjovsky et al., 2017) framework
...
![](/assets/img/Pasted%20image%2020240126172108.png)
*DPGAN Algorithm*
