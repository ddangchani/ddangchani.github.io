...
description: >-
  Summarize - Uniform grid approach for balancing the noise error and the
  non-uniformity error - Proposed a method for choosing the grid size. -
  Traditional differentially private methods for 2D datasets : quadtrees, kd...
date: "2024-01-17"
tags:
...
draft: false
canonicalUrl: >-
  https://ddangchani.github.io/Differentially%20Private%20Grids%20for%20Geospatial%20Data/
---
