...
description: >-
  Graph Clustering Graph Clustering Graph Clustering(혹은 community recovery)란, 위
  그림과 같이 그래프의 노드들을 서로 다른 커뮤니티(그룹)으로 나누는 방법론을 의미한다. 특히 소셜 미디어의 발달로 인해 최근 들어 개인간
  연결성이 강조되며, SNA(social network analysis) 영역에서 주로 연구되는 방법론이며, 컴퓨...
date: "2023-08-05"
tags:
  - Clustering
  - Spectral Analysis
...
coverImage: /assets/img/Spectral-Analysis-4_0.png
excerpt: >-
  Graph Clustering Graph Clustering Graph Clustering(혹은 community recovery)란, 위
  그림과 같이 그래프의 노드들을 서로 다른 커뮤니티(그룹)으로 나누는 방법론을 의미한다. 특히 소셜 미디어의 발달로 인해 최근 들어 개인간
  연결성이 강조되며, SNA(social network analysis) 영역에서 주로 연구되는 방법론이며, 컴퓨...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/Spectral-Analysis-4/
---
...
### Lemma
이전 spectral analysis 방법론들과 마찬가지로 David-Kahan $\sin\Theta$ [theorem](/Spectral-Analysis-1/) 을 사용하기 위해 우선 perturbation matrix $E$의 크기를 제한해야 한다. 이는 다음 lemma로부터 얻을 수 있다.
