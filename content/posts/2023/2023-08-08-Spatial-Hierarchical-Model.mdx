...
description: >-
  The contents are mainly based on "Handbook of Spatial Statistics"(2010)
  textbook. In this chapter, we introduce some basic concept related to
  hierarchical modeling strategies for handling and modeling spatial data. Hi...
date: "2023-08-08"
tags:
  - Spatial Statistics
  - Bayesian
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/Spatial-Hierarchical-Model/
---
