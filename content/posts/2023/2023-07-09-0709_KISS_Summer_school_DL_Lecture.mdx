...
description: >-
  Introduction to DL Traditional Linear Model > suffers at specific tasks(ex.
  MNIST) - Why : Designed to use at low-dimensional data - At higher
  dimension(ex. Image, Video data) : curse of dimensionality occurs - How ab...
date: "2023-07-09"
tags:
  - Deep Learning
  - Machine Learning
...
routeSegments:
  - deep learning
  - 0709_KISS_Summer_school_DL_Lecture
teaser: null
coverImage: null
excerpt: >-
  Introduction to DL Traditional Linear Model > suffers at specific tasks(ex.
...
draft: false
canonicalUrl: >-
  https://ddangchani.github.io/deep%20learning/0709_KISS_Summer_school_DL_Lecture/
---
