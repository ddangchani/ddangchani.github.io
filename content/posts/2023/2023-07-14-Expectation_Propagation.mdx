...
description: >-
  Expectation Propagation(EP) 알고리즘은 Laplace approximation에서 살펴본 것과 같이 사후확률분포를
  근사하는 알고리즘 중 하나이다. 이번 글에서는 Expectation Propagation 알고리즘을 살펴보고 Gaussian Process에
  어떻게 적용될 수 있는지와 Laplace approximation과 어떤 성능 차이를 보이는지를 살펴보고자 한다...
date: "2023-07-14"
tags:
  - Gaussian Process
  - Bayesian
...
coverImage: /assets/img/Expectation_Propagation_2.png
excerpt: >-
  Expectation Propagation(EP) 알고리즘은 Laplace approximation에서 살펴본 것과 같이 사후확률분포를
  근사하는 알고리즘 중 하나이다. 이번 글에서는 Expectation Propagation 알고리즘을 살펴보고 Gaussian Process에
  어떻게 적용될 수 있는지와 Laplace approximation과 어떤 성능 차이를 보이는지를 살펴보고자 한다...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/machine%20learning/Expectation_Propagation/
---
