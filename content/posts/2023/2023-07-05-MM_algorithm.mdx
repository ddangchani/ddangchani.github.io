...
title: MM algorithm
description: >-
  MM algorithm은 EM algorithm의 일반화된 버전으로 이해하면 되는데, MM은 maximization 관점에서
  minorize-maximize를 나타낸다. MM algorithm은 최대화하고자 하는 목적함수 $l(\theta)$ 에 대한 lower
  bound function(surrogate function) $Q(\theta,\theta^{t})$ 를 찾고 이를 maxi...
date: "2023-07-05"
tags:
  - Optimization
  - Machine Learning
...
coverImage: /assets/img/MM_algorithm_0.png
excerpt: >-
  MM algorithm은 EM algorithm의 일반화된 버전으로 이해하면 되는데, MM은 maximization 관점에서
  minorize-maximize를 나타낸다. MM algorithm은 최대화하고자 하는 목적함수 $l(\theta)$ 에 대한 lower
  bound function(surrogate function) $Q(\theta,\theta^{t})$ 를 찾고 이를 maxi...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/statistics/MM_algorithm/
---
