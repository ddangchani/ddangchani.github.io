...
description: >-
  이전에 지킬 블로그를 시작하면서, 태그 기능을 완벽하게 구현해내신 블로그가 있길래 아이디어를 참고하여 게시글 리스트를 보여주는 화면에 태그
  정렬 기능을 위 그림과 같이 설정해보았다. 현재 사용하고 있는 Jekyll의 블로그 테마는 minimal-mistake 이므로 본인이
  사용하고 있는 테마의 파일구조에 맞추어서 확인하면 될 것이다. 포스트에 태그 추가하기 Jekyll에서 포스트를 작성...
date: "2023-08-22"
tags:
  - Front-end
  - Jekyll
...
draft: false
canonicalUrl: >-
  https://ddangchani.github.io/Jekyll-Tag-%EA%B8%B0%EB%8A%A5-%EC%B6%94%EA%B0%80%ED%95%98%EA%B8%B0/
---

![](/assets/img/%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7%202023-08-22%20%EC%98%A4%ED%9B%84%209.22.50.png)
...
- 태그 2
header: 
  teaser: /assets/img/%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7%202023-08-22%20%EC%98%A4%ED%9B%84%209.22.50.png
---
