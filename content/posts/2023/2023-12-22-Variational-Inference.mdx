...
description: >-
  Coordinate Ascent Variational Inference Variational Inference 변분추론 Variational
  Inference 이란, 베이지안 추론의 근사적 방법론 중 하나입니다. 베이지안 추론에서 사후분포의 확률밀도함수는 다음과 같이 계산할 수
  있습니다. $$ p{Z|X}(z|x) = \frac{p{X|Z}(x|z)pZ(z)}{\int p{X|Z}(x|...
date: "2023-12-22"
tags:
  - Bayesian
...
routeSegments:
  - Variational-Inference
teaser: >-
  /assets/img/4.%20%EB%B3%80%EB%B6%84%EC%B6%94%EB%A1%A0%20%EC%8B%A4%EC%8A%B5_7_0.png
coverImage: >-
  /assets/img/4.%20%EB%B3%80%EB%B6%84%EC%B6%94%EB%A1%A0%20%EC%8B%A4%EC%8A%B5_7_0.png
excerpt: >-
  Coordinate Ascent Variational Inference Variational Inference 변분추론 Variational
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/Variational-Inference/
---
...
만일 잠재변수 간에 Bayes Net이 존재한다면, 앞서 언급한 $\mathrm{E}_{-i}$ 처럼 $i$번째 잠재변수를 제외한 나머지를 모두 사용할 필요가 없게 됩니다. 이는 $p(x,z)$ 가 factorized 될 수 있기 때문인데, 이로부터 기댓값을 계산할 때 [Markov blanket](/BN-and-MRF/)만을 이용하면 됩니다. 즉, 아래와 같이 업데이트가 이루어집니다.
...
![png](/assets/img/4.%20%EB%B3%80%EB%B6%84%EC%B6%94%EB%A1%A0%20%EC%8B%A4%EC%8A%B5_7_0.png)
...
![png](/assets/img/4.%20%EB%B3%80%EB%B6%84%EC%B6%94%EB%A1%A0%20%EC%8B%A4%EC%8A%B5_15_0.png)
