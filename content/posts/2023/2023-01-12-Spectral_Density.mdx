...
description: >-
  Spectral Representation Theorem 시계열 자료는 $\lbrace x{t}: t=1\ldots T\rbrace $
  형태로 discrete하게 주어진다. 반면, 파동함수(cosine, sine function)를 이용해 시계열 자료를 근사하는 방법이
  있는데, 이러한 형태로 주어진 자료를 spectral 하다고 한다. Spectral Representation Theo...
date: "2023-01-12"
tags:
  - Time Series
...
coverImage: /assets/img/Spectral_Density_0.png
excerpt: >-
  Spectral Representation Theorem 시계열 자료는 $\lbrace x{t}: t=1\ldots T\rbrace $
  형태로 discrete하게 주어진다. 반면, 파동함수(cosine, sine function)를 이용해 시계열 자료를 근사하는 방법이
  있는데, 이러한 형태로 주어진 자료를 spectral 하다고 한다. Spectral Representation Theo...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/time%20series/Spectral_Density/
---
