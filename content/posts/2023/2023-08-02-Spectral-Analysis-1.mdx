...
description: >-
  Basics of matrix analysis Perturbation 실행렬 $M^{\star}$와 교란(perturbed)된 실행렬 $M$
  에 대해 다음 관계를 가정하자. $$ M=M^{\star}+E $$ 여기서 $E$는 perturbation matrix 라고 하며,
  통계학적인 관점에서 $M, M^{\star}$ 이 각각 관측치와 기댓값이라면 $E$를 오차 정도로 볼 수 있다(아래...
date: "2023-08-02"
tags:
  - Spectral Analysis
  - Clustering
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/Spectral-Analysis-1/
---
