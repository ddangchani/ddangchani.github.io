...
description: >-
  크롬 브라우저의 백준허브를 이용하면 프로그래머스와 백준에서 푼 코딩테스트 연습문제들을 깃허브에 자동으로 커밋&푸시 해주는데, 이 결과를
  이용해 아래처럼 블로그에도 자동으로 포스트를 생성할 수 있게 코드를 짜보았다. 1. 로컬저장소에 알고리즘 깃 저장소 불러오기 2. 디렉토리
  변수 설정 blogdir와 targetdir 에 ...은 자신의 로컬 환경에 맞게 수정하면 된다. question...
date: "2023-08-18"
tags:
  - ETC
  - Jekyll
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/baekjoonhub/
---
...
for q_dir in questions:
 ...
 'use_math: true\n',
 'header: \n',
 ' teaser: /assets/logos/teaser_coding.jpg%5Cn',
 '---\n']
