...
title: DAG-GNN
description: >-
  DAG-GNN 이번 포스트는 DAG-GNN: DAG Structure Learning with Graph Neural Networks의 논문
  요약입니다. Graph Learning 그래프 학습 Graph Learning 이란, 주어진 관측 데이터 $\mathbf{X}$로부터
  데이터가 생성된 그래프 $\mathcal{G}$의 구조를 추정하는 것이다. 그래프의 구조는 인접행렬 $A\in \...
date: "2023-12-23"
tags:
  - Deep Learning
...
routeSegments:
  - DAG-GNN
teaser: /assets/img/Pasted%20image%2020231222190454.png
coverImage: /assets/img/Pasted%20image%2020231222190454.png
excerpt: >-
  DAG-GNN 이번 포스트는 DAG-GNN: DAG Structure Learning with Graph Neural Networks의 논문
  요약입니다. Graph Learning 그래프 학습 Graph Learning 이란, 주어진 관측 데이터 $\mathbf{X}$로부터
  데이터가 생성된 그래프 $\mathcal{G}$의 구조를 추정하는 것이다. 그래프의 구조는 인접행렬 $A\in \...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/DAG-GNN/
---
...
![](/assets/img/Pasted%20image%2020231222190454.png)
