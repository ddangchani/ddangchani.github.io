...
description: >-
  [level 3] 양과 늑대 - 92343 문제 링크 성능 요약 메모리: 10.2 MB, 시간: 0.28 ms 구분 코딩테스트 연습 >
  2022 KAKAO BLIND RECRUITMENT 채점결과 Empty 문제 설명 문제 설명 2진 트리 모양 초원의 각 노드에 늑대와 양이
  한 마리씩 놓여 있습니다. 이 초원의 루트 노드에서 출발하여 각 노드를 돌아다니며 양을 모으려 합니다. 각 노드를...
date: "2023-08-29"
tags:
  - Algorithm
  - Coding Test
...
draft: false
canonicalUrl: >-
  https://ddangchani.github.io/%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%98%EB%A8%B8%EC%8A%A4-92343/
---
...
- DFS를 이용하는데, 한번 방문한 노드를 재방문하는것은 의미가 없기 때문에 `next_node`라는 리스트를 만들어서 다음 방문할 노드를 실시간으로 저장한다.
- 이를 이용하면 단방향 그래프만으로도 모든 노드를 방문할 수 있다.
