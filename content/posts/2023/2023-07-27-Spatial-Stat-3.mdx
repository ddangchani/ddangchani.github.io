...
title: Point Process
description: >-
  Point Process Definition Notation - $\mathcal{S}$ : a metric space with metric
  $d$ - $X$ : point process on $\mathcal{S}$ - $x$ : realization of a point
  process $X$ - $x$ is said to be locally finite if $n(xB) 0$. $wd...
date: "2023-07-27"
tags:
  - Spatial Statistics
  - Point Process
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/statistics/Spatial-Stat-3/
---
