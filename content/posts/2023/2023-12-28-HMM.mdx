...
description: >-
  Hidden Markov Model 은닉 마코프 모형 Hidden Markov Model, HMM 이란 message passing
  algorithm(or belief propagation algorithm)의 일종이다. 여기서 message passing이란, 그래프
  구조에서 각 노드가 다음 노드로 정보를 전달하며 어떤 결론을 도출하는 과정을 의미하는데, 전달되는 정보는 확률분포 형태...
date: "2023-12-28"
tags:
  - PGM
  - Machine Learning
...
routeSegments:
  - HMM
teaser: /assets/img/Pasted%20image%2020231228193617.png
coverImage: /assets/img/Pasted%20image%2020231228193617.png
excerpt: >-
  Hidden Markov Model 은닉 마코프 모형 Hidden Markov Model, HMM 이란 message passing
  algorithm(or belief propagation algorithm)의 일종이다. 여기서 message passing이란, 그래프
  구조에서 각 노드가 다음 노드로 정보를 전달하며 어떤 결론을 도출하는 과정을 의미하는데, 전달되는 정보는 확률분포 형태...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/HMM/
---
...
![](/assets/img/Pasted%20image%2020231228193617.png)
...
![](/assets/img/%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7%202023-12-28%20%EC%98%A4%ED%9B%84%209.46.18.png)
