...
description: >-
  Lebesgue Integral General Vitali Theorem Def $E$에서의 가측함수들의 집합족 $\mathcal F$가
  다음을 만족할 때 $E$에서 Tight 하다고 정의한다. $$\forall \epsilon>0,\; \exists E0 \subseteq E
  \text{ w/ } m(E0) 일반화된 비탈리 수렴정리 가측집합 $E$에서의 함수열 {$fn$}이 균등적분가...
date: "2021-12-07"
tags:
  - Mathematics
  - Real Analysis
...
draft: false
canonicalUrl: >-
  https://ddangchani.github.io/mathematics/%EC%8B%A4%ED%95%B4%EC%84%9D%ED%95%999/
---
