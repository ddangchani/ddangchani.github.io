...
title: Real Numbers
description: >-
  1. Three Major Axioms in Real Numbers 1. Field Axiom (체공리) 다음 9가지 성질을 만족하는 set
  $F$ 를 Field(체) 라고 정의한다. 덧셈에 대한 교환법칙(Commutativity) 덧셈에 대한 결합법칙(Associativity)
  덧셈에 대한 항등원(Identity) 존재 덧셈에 대한 역원(Inverse) 존재 곱셈에 대한 교환법칙(Co...
date: "2021-11-28"
tags:
  - Mathematics
  - Real Analysis
...
draft: false
canonicalUrl: >-
  https://ddangchani.github.io/mathematics/%EC%8B%A4%ED%95%B4%EC%84%9D%ED%95%991/
---
