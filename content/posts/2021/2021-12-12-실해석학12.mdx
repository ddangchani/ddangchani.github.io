...
title: Duality
description: >-
  Duality 선형 범함수 쌍대성(Duality)을 정의하기 이전에, 선형 범함수(linear functional)에 대해 알 필요가 있다.
  우선 범함수란, 함수들의 함수로 어떠한 함수공간을 정의역으로 하고 실수 혹은 복소수 집합을 공역으로 하는 함수이다. 이때, 함수공간은
  벡터공간이기 때문에 벡터공간에서부터 실수로 정의되는 함수로 이해하는 것이 쉽다. 예로 이전에 살펴보았던 르벡 적분...
date: "2021-12-12"
tags:
  - Mathematics
  - Real Analysis
...
draft: false
canonicalUrl: >-
  https://ddangchani.github.io/mathematics/%EC%8B%A4%ED%95%B4%EC%84%9D%ED%95%9912/
---
