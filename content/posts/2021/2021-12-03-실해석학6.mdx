...
description: >-
  Lebesgue Measurable Function (2) Egoroff's THM THM. 유한 측도를 갖는 가측집합 $E$와 $E$에서의
  실함수열 $\lbrace fn\rbrace $에 대해 $fn \to f$ 일때 $\cdots$ (a) $\forall \epsilon>0$
  에 대해 닫힌 집합 $F$가 존재하여 $F$에서 $fn$이 $f$로 균등수렴하고 $m(E-F) 0$에 대해...
date: "2021-12-03"
tags:
  - Mathematics
  - Real Analysis
...
draft: false
canonicalUrl: >-
  https://ddangchani.github.io/mathematics/%EC%8B%A4%ED%95%B4%EC%84%9D%ED%95%996/
---
