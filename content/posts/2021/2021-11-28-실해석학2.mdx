...
title: Sigma Algebra
description: >-
  1. Countability Def 집합 $E$가 가산무한집합 Countably finite set : $E$가 자연수 집합
  $\mathbb{N}$과 equipotent하다. 2. $\sigma$-Algebra Def 집합 $X$의 부분집합들의 모임
  collection $F$가 다음 조건을 만족하면 $F$를 $X$의 시그마 대수라고 한다. P1. $\emptyset \in F$
  P2....
date: "2021-11-28"
tags:
  - Mathematics
...
draft: false
canonicalUrl: >-
  https://ddangchani.github.io/mathematics/%EC%8B%A4%ED%95%B4%EC%84%9D%ED%95%992/
---
