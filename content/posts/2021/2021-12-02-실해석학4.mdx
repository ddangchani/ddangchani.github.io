...
description: >-
  Lebesgue Measure (르벡 측도) 3. Outer / Inner Approximation of Lebesgue measurable
  sets Excision Property - 유한 외측도(finite outer measure)를 갖는 가측 집합 $A$가 $A
  \subseteq B$를 만족한다면 $$m^{\ast}(B-A) = m^{\ast}(B)-m^{\ast}(A)$$ (단...
date: "2021-12-02"
tags:
  - Mathematics
  - Real Analysis
...
draft: false
canonicalUrl: >-
  https://ddangchani.github.io/mathematics/%EC%8B%A4%ED%95%B4%EC%84%9D%ED%95%994/
---
