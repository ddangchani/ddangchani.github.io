...
description: >-
  이번 포스트에서는 'An Introduction to Kernel-Based Learning Algorithms' 라는 Paper을 리뷰하며
  머신러닝에서 널리 사용되는 커널 이론의 원리와 배경에 대해 알아보고자 한다. 이번 장에서는 먼저 커널 함수가 대표적으로 이용되는 서포트 벡터
  머신을 간단하게 살펴볼 것이다, 분류 이론의 기초 서포트 벡터 머신은 회귀 문제에도 사용되지만, 대표적인...
date: "2021-12-05"
tags:
  - Kernel Methods
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/machine%20learning/kernel1/
---
