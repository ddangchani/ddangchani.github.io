...
description: >-
  바나흐 고정점 정리 바나흐 고정점 정리(혹은 축약 사상 정리)는 축약사상에 대해 고정점이 하나만 존재한다는 정리이다. 우선 이를 알기 위해
  축약 사상과 고정점의 개념에 대해 다루어보자. Def 거리공간 X에서의 점 $x\in X$ 와 사상 $T:X\to X$ 에 대해
  $T(x)=x$ 이 성립하면 점 $x$를 X의 고정점이라고 한다. Def 거리공간 $(X,\rho)$ 에서의 사상 $T$...
date: "2021-12-25"
tags:
  - Mathematics
  - Real Analysis
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/mathematics/realanalysis_BCP/
---
