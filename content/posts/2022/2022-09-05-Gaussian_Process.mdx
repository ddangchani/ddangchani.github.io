...
description: >-
  Gaussian Process (1) Definition Gaussian Process(줄여서 GP라고도 한다)는 비모수방법의 일종으로,
  사전분포를 표현하여 베이즈 정리를 바탕으로 사후확률을 추론하는 기법으로 사용된다. 길이 $N$의 가우시안 랜덤 벡터(Gaussian
  Random Vector)란 $$ \mathbf{f} = [f1,\ldots,fN] $$ 의 형태로 주어지며, 평균벡터...
date: "2022-09-05"
tags:
  - Machine Learning
  - Gaussian Process
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/machine%20learning/Gaussian_Process/
---
