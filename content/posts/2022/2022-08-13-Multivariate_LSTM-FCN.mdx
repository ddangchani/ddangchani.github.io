...
description: >-
  Multivariate LSTM-FCN 이번 글에서는 저번에 살펴본 단변량 시계열 분류모형인 LSTM-FCN을 다변량으로 확장한
  Multivariate LSTM-FCN을 살펴보도록 할 것이다. 모형의 근본적인 구조는 LSTM-FCN과 동일하지만 convolutional
  layer들에서 Squeeze and Excite 라는 새로운 블록이 추가된다. Squeeze and Excite 블록...
date: "2022-08-13"
tags:
  - Deep Learning
  - LSTM
...
routeSegments:
  - deep learning
  - Multivariate_LSTM-FCN
teaser: /assets/img/Multivariate_LSTM-FCN_1.jpg
coverImage: /assets/img/Multivariate_LSTM-FCN_1.jpg
excerpt: >-
  Multivariate LSTM-FCN 이번 글에서는 저번에 살펴본 단변량 시계열 분류모형인 LSTM-FCN을 다변량으로 확장한
  Multivariate LSTM-FCN을 살펴보도록 할 것이다. 모형의 근본적인 구조는 LSTM-FCN과 동일하지만 convolutional
  layer들에서 Squeeze and Excite 라는 새로운 블록이 추가된다. Squeeze and Excite 블록...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/deep%20learning/Multivariate_LSTM-FCN/
---
