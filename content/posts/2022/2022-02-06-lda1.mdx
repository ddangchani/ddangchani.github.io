...
description: >-
  Linear Classification 이번 포스트부터는 선형 방법으로 분류 문제를 해결하는 방법들에 대해 살펴보고자 한다. 여기서 분류
  classification 문제란, 종속 변수와 예측값 $G(x)$ 가 이산집합 $\mathcal{G}$의 원소를 갖는 문제를 의미한다.
  분류 문제의 핵심은 결정경계 decision boundary 를 찾는 것인데, 결정경계가 선형인 것들만 우선 다루...
date: "2022-02-06"
tags:
  - Linear Model
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/linear%20model/lda1/
---
