...
description: >-
  Convolutional Neural Network Convolutional Neural Network(이하 CNN)은 합성곱 신경망이라고
  불리는데, 딥러닝의 여러 활용 분야 중 특히 computer vision 영역에서 주로 사용된다. Gradient-Based learning
  applied to Document Recognition 이라는 1998년 논문(링크)에서 손글씨 이미지를...
date: "2022-03-27"
tags:
  - CNN
  - Deep Learning
...
coverImage: /assets/img/CNN.assets/CNN_4.png
excerpt: >-
  Convolutional Neural Network Convolutional Neural Network(이하 CNN)은 합성곱 신경망이라고
  불리는데, 딥러닝의 여러 활용 분야 중 특히 computer vision 영역에서 주로 사용된다. Gradient-Based learning
  applied to Document Recognition 이라는 1998년 논문(링크)에서 손글씨 이미지를...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/deep%20learning/CNN/
---
