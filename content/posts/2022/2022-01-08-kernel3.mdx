...
description: >-
  무한차원특성공간 vs 유한차원특성공간 커널 트릭에서 살펴보았듯이, 커널을 이용하면 데이터셋을 특성 매핑(feature mapping)을
  사용하지 않고도 동일한 연산을 수행할 수 있다. Input Space $\mathbf{X}$의 데이터가 벡터
  $\mathbf{x1,\ldots,xk}$ 로 주어진다고 하자. 특성 매핑(사상)
  $\phi(\mathbf{x}):\mathbf{X}\to\ma...
date: "2022-01-08"
tags:
  - Machine Learning
  - Kernel Theory
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/machine%20learning/kernel3/
---
