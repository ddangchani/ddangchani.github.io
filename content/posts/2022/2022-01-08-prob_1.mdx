...
description: >-
  확률측도 정의 공간 $\Omega$와 $\Omega$의 부분집합들로 구성된 Borel Field $\mathscr{F}$ 에서 정의된
  확률측도 probability measure $P$ 는 다음 공리를 만족시킨다. 1. $\forall E\in \mathscr{F}:
  P(E)\geq 0$ 2. (가산가법성) $\mathscr{F}$의 서로소인 가산모임 {$Ek:k\in \mathbb{N...
date: "2022-01-08"
tags:
  - Probability Theory
  - Probability Measure
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/probability%20theory/prob_1/
---
