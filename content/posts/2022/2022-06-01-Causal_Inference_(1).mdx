...
description: >-
  Causal Inference Causal Inference, 즉 인과관계추론은 통계학의 한 분야로 사회과학 등 다양한 분야에 응용될 수
  있는 영역이다. 2021년 노벨경제학상이 인과관계추론 분야에서 수상되며 전통적인 방법론이었으면서도, 최근 통계학의 중요한 분야로 떠오르는
  추세이다. 기존의 선형모형론부터 최근의 데이터사이언스 기법들은 대개 input data와 target variab...
date: "2022-06-01"
tags:
  - Causal Inference
  - Statistics
...
routeSegments:
  - causal inference
  - Causal_Inference_(1)
teaser: /assets/img/Causal_Inference_%281%29_0.jpg
coverImage: /assets/img/Causal_Inference_%281%29_0.jpg
excerpt: >-
  Causal Inference Causal Inference, 즉 인과관계추론은 통계학의 한 분야로 사회과학 등 다양한 분야에 응용될 수
  있는 영역이다. 2021년 노벨경제학상이 인과관계추론 분야에서 수상되며 전통적인 방법론이었으면서도, 최근 통계학의 중요한 분야로 떠오르는
  추세이다. 기존의 선형모형론부터 최근의 데이터사이언스 기법들은 대개 input data와 target variab...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/causal%20inference/Causal_Inference_(1)/
---
...
## Causal Modeling
![](/assets/img/Causal_Inference_%281%29_0.jpg)
...
![](/assets/img/Causal_Inference_%281%29_1.jpg)
