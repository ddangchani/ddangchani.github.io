...
description: >-
  Lebesgue Integration with General Measure 이전 글들에서 르벡 측도를 이용해 정의한 르벡적분과 앞으로 살펴볼
  일반측도 $\mu$를 이용해 정의하는 르벡적분은 크게 다르지 않다. 르벡측도를 이용한 르벡적분은 $\mu=m$ 의 특수한 경우이지만 대부분의
  중요한 정리들은 그대로 성립한다. 르벡적분의 정의 이전에 살펴본 단순함수근사로부터 양함수 $f:X\to[0...
date: "2022-02-24"
tags:
  - Mathematics
  - Real Analysis
...
routeSegments:
  - mathematics
  - Lebesgue_Integration_with_General_measure
teaser: null
coverImage: null
excerpt: >-
  Lebesgue Integration with General Measure 이전 글들에서 르벡 측도를 이용해 정의한 르벡적분과 앞으로 살펴볼
...
draft: false
canonicalUrl: >-
  https://ddangchani.github.io/mathematics/Lebesgue_Integration_with_General_measure/
---
