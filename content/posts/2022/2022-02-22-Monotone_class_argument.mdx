...
description: >-
  Monotone Class Argument Dynkin's $\pi-\lambda$ system이라고도 불리는 체계는 실변수함수론에서 다양한
  정리들을 증명하거나 할 때 유용하게 사용된다. 또한, 확률론에서도 사건이나 random event의 독립성을 확인할 때 역시 이용된다. 우선
  $\pi$ system, $\lambda$ system이 무엇인지 살펴보고, 간단한 예시를 통해 이들이 어...
date: "2022-02-22"
tags:
  - Probability Theory
  - Measure Theory
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/probability%20theory/Monotone_class_argument/
---
