...
description: >-
  Conditional Expectations Measure Theory를 기반으로 한 조건부 기댓값 및 조건부 확률을 정의해보도록 하자.
  일반적으로 measure를 다루지 않는 통계학에서는 조건부 확률을 먼저 정의하고, 이후에 조건부 기댓값을 조건부 확률을 이용해 정의하는데
  measure를 이용하면 좀 더 엄밀한 정의가 가능하다. 또한, 측도를 기반으로 한 새로운 조건부 기댓값의 정의와...
date: "2022-12-10"
tags:
  - Probability Theory
  - Statistics
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/probability%20theory/Conditional_Expectations/
---
