...
description: >-
  측도의 일반화 이전까지 다루었던 측도의 개념은 르벡 측도에 관한 것으로, 가측집합의 모임들이 시그마 대수인 것을 외측도의 제한으로 보였으며,
  이를 통해 측도론을 구성해왔다. 이를 르벡 측도의 Caratheodory construction 이라고 부르는데, 여기서는 이러한 기술을 좀
  더 일반화하는 방법을 살펴본다. 흔히 통계학에서 다루는 확률 측도 probability measure 의...
date: "2022-01-06"
tags:
  - Mathematics
  - Real Analysis
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/mathematics/gms_1/
---
