...
description: >-
  Gradient Boosting Machine 이번 글에서는 Boosting 알고리즘과 관련하여, 특히 함수추정과 예측 문제에서 뛰어난
  성능을 보이는 Gradient Boosting Machine에 대해 살펴보고자 한다. 여기서는 GBM을 제안한 Jerome H.
  Friedman의 Greedy Function Approximation: A Gradient Boosting Machine...
date: "2022-04-17"
tags:
  - Machine Learning
  - GBM
...
routeSegments:
  - machine learning
  - Gradient_Boosting
teaser: /assets/img/Gradient%20Boosting.assets/Gradient_Boosting_1.png
coverImage: /assets/img/Gradient%20Boosting.assets/Gradient_Boosting_1.png
excerpt: >-
  Gradient Boosting Machine 이번 글에서는 Boosting 알고리즘과 관련하여, 특히 함수추정과 예측 문제에서 뛰어난
  성능을 보이는 Gradient Boosting Machine에 대해 살펴보고자 한다. 여기서는 GBM을 제안한 Jerome H.
  Friedman의 Greedy Function Approximation: A Gradient Boosting Machine...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/machine%20learning/Gradient_Boosting/
---
...
![스크린샷 2022-04-18 오전 10.26.16](/assets/img/Gradient%20Boosting.assets/Gradient_Boosting_0.png){: .align-center}
...
![](/assets/img/Gradient%20Boosting.assets/Gradient_Boosting_1.png){: .align-center}
...
![](/assets/img/Gradient%20Boosting.assets/Gradient_Boosting_2.png){: .align-center}
