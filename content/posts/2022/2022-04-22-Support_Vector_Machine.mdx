...
description: >-
  Support Vector Machine 이전에 Linear Classification에서 Fischer's LDA에 대해 다룬 적 있었다.
  이는 특성공간에서 데이터들을 분류하기 위한 선형 경계를 만드는 것인데, support vector classifier/machine은 이와
  유사하나 비선형인 결정경계를 만들 수 있다는 점에서 좀 더 일반화된 개념으로 생각하면 된다. Support...
date: "2022-04-22"
tags:
  - Machine Learning
  - SVM
...
teaser: /assets/img/Support%20Vector%20Machine.assets/Support_Vector_Machine_0.png
coverImage: /assets/img/Support%20Vector%20Machine.assets/Support_Vector_Machine_0.png
excerpt: >-
  Support Vector Machine 이전에 Linear Classification에서 Fischer's LDA에 대해 다룬 적 있었다.
  이는 특성공간에서 데이터들을 분류하기 위한 선형 경계를 만드는 것인데, support vector classifier/machine은 이와
  유사하나 비선형인 결정경계를 만들 수 있다는 점에서 좀 더 일반화된 개념으로 생각하면 된다. Support...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/machine%20learning/Support_Vector_Machine/
---
...
![](/assets/img/Support%20Vector%20Machine.assets/Support_Vector_Machine_0.png){: .align-center width="70%" height="70%"}
