...
description: >-
  위상공간에서의 연속사상 정의 위상공간 $(X,\mathcal{T})$와 $(Y,\mathcal{S})$ 를 연결하는 사상 $f:X\to Y$
  가 점 $x0$에서 연속이기 위한 조건은 다음과 같다. $f(x0)$의 임의의 근방 $\mathcal{O}$ 에 대해 $x0$의 근방
  $\mathcal{U}$ 가 존재하여 $f(\mathcal{U)}\subseteq\mathcal{O}$ 가 성립한...
date: "2022-01-01"
tags:
  - Mathematics
  - Real Analysis
...
routeSegments:
  - mathematics
  - realanalysis_Topological_spaces(3)
teaser: null
coverImage: null
excerpt: >-
  위상공간에서의 연속사상 정의 위상공간 $(X,\mathcal{T})$와 $(Y,\mathcal{S})$ 를 연결하는 사상 $f:X\to Y$
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/mathematics/realanalysis_Topological_spaces(3)/
---
