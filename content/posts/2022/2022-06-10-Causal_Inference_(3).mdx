...
description: >-
  Learning Cause-Effect Models 통계적 학습이론(Statistical Learning)의 관점에서 살펴보면, 가장 간단한
  케이스인 cause-effect model을 학습하는 것 조차 어려움이 존재한다. Statistical Learning은 소위 주어진 관측값
  $(X,Y){i=1\ldots,N}$ 들로부터(observation) $X,Y$의 joint distrib...
date: "2022-06-10"
tags:
  - Statistics
  - Causal Inference
...
routeSegments:
  - causal inference
  - Causal_Inference_(3)
teaser: /assets/img/Causal%20Inference%20%283%29.assets/Causal_Inference_%283%29_0.png
coverImage: /assets/img/Causal%20Inference%20%283%29.assets/Causal_Inference_%283%29_0.png
excerpt: >-
  Learning Cause-Effect Models 통계적 학습이론(Statistical Learning)의 관점에서 살펴보면, 가장 간단한
  케이스인 cause-effect model을 학습하는 것 조차 어려움이 존재한다. Statistical Learning은 소위 주어진 관측값
  $(X,Y){i=1\ldots,N}$ 들로부터(observation) $X,Y$의 joint distrib...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/causal%20inference/Causal_Inference_(3)/
---
...
![image-20220610194348077](/assets/img/Causal%20Inference%20%283%29.assets/Causal_Inference_%283%29_0.png){: .align-center}
