...
description: >-
  Cross-Validation Cross-validation 교차검증 은 prediction error을 추정하는 과정에서 가장 널리
  사용되는 방법 중 하나이다. 딥러닝을 포함한 대부분의 머신러닝 영역에서 기본적으로 교차검증을 사용하며, 또한 대부분의 패키지 역시 이와
  관련된 메서드를 포함한다. 이번 글에서는 교차검증의 이론적인 내용을 살펴보도록 하자. K-Fold Cross Valid...
date: "2022-03-30"
tags:
  - Machine Learning
  - Cross Validation
...
routeSegments:
  - machine learning
  - Cross_Validation
teaser: /assets/img/Cross%20Validation.assets/Cross_Validation_0.png
coverImage: /assets/img/Cross%20Validation.assets/Cross_Validation_0.png
excerpt: >-
  Cross-Validation Cross-validation 교차검증 은 prediction error을 추정하는 과정에서 가장 널리
  사용되는 방법 중 하나이다. 딥러닝을 포함한 대부분의 머신러닝 영역에서 기본적으로 교차검증을 사용하며, 또한 대부분의 패키지 역시 이와
  관련된 메서드를 포함한다. 이번 글에서는 교차검증의 이론적인 내용을 살펴보도록 하자. K-Fold Cross Valid...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/machine%20learning/Cross_Validation/
---
...
![스크린샷 2022-04-03 오전 9.54.26](/assets/img/Cross%20Validation.assets/Cross_Validation_0.png){: .align-center}
...
<img src="/assets/img/Cross%20Validation.assets/Cross_Validation_1.png" alt="스크린샷 2022-04-03 오후 12.17.56"/>
