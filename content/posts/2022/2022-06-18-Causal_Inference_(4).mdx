...
description: >-
  Learning Cause-Effect Models (2) 이번 게시글에서는 저번/)에 이어 다른 Cause-Effect 모델들과 이들의
  식별가능성에 대해 계속 살펴보도록 하자. Post-nonlinear Models Post-nonlinear model은 이전에 살펴본
  Nonlinear ANM의 일반화된 모델이다. 결합분포 $P{X,Y}$가 X에서 Y로의 post-nonlinear m...
date: "2022-06-18"
tags:
  - Causal Inference
  - Statistics
...
routeSegments:
  - causal inference
  - Causal_Inference_(4)
teaser: /assets/img/Causal_Inference_%284%29_0.jpg
coverImage: /assets/img/Causal_Inference_%284%29_0.jpg
excerpt: >-
  Learning Cause-Effect Models (2) 이번 게시글에서는 저번/)에 이어 다른 Cause-Effect 모델들과 이들의
  식별가능성에 대해 계속 살펴보도록 하자. Post-nonlinear Models Post-nonlinear model은 이전에 살펴본
  Nonlinear ANM의 일반화된 모델이다. 결합분포 $P{X,Y}$가 X에서 Y로의 post-nonlinear m...
...
featured: false
draft: false
canonicalUrl: https://ddangchani.github.io/causal%20inference/Causal_Inference_(4)/
---
...
![](/assets/img/Causal_Inference_%284%29_0.jpg)
...
![](/assets/img/Causal_Inference_%284%29_1.jpg)
