...
위 코드를 실행하면, 다음과 같은 세 그래프를 얻을 수 있는데, Lasso method가 계수의 수렴이 가장 느리며, Ridge가 가장 빠르게 수렴함을 확인할 수 있다.
 ...
 <img src="/assets/img/따릉이_shrinkage_0.png" alt="스크린샷 2022-04-11 오후 4.07.18" style="zoom:75%;" />
...
<img src="/assets/img/따릉이_shrinkage_1.png" alt="스크린샷 2022-04-11 오후 7.19.09" style="zoom=75%;" />
