...
<img src="따릉이_Tree.assets/스크린샷 2022-04-21 오후 2.12.13.png" alt="스크린샷 2022-04-21 오후 2.12.13" style="zoom:50%;" />
...
<img src="따릉이_Tree.assets/GridSearch_Tree.png" alt="GridSearch_Tree" style="zoom:50%;" />
...
<img src="따릉이_Tree.assets/tree_pca.png" alt="tree_pca" style="zoom:50%;" />
...
![tree_gbm_gridsearchcv](따릉이_Tree.assets/tree_gbm_gridsearchcv.png)
...
이제 마지막으로 트리 활용 모델 중 가장 인기(?)있다고 할 수 있는 [랜덤포레스트](https://velog.io/@ddangchani/Random-Forest) 모델을 구현해보도록 하자. 랜덤포레스트 모델도 마찬가지로 튜닝해야할 Hyperparmeter가 존재하기 때문에, 적절한 hyperparameter을 선택하여 Gridsearch를 진행해보도록 하겠다(*Colab 이용*). 총 네 개의 hyperparmeter `n_estimators`(랜덤포레스트당 개별 트리의 개수), `max_features`, `max_depth`, `min_samples_split`(한 노드를 split하기 위해 필요한 최소한의 샘플 개수) 에 대해 적당한 값을 Grid로 취하여 훈련을 진행했다.
...
![rf_variable_importance](따릉이_Tree.assets/rf_variable_importance.png)
