...
use_math: true
header: 
 teaser: /assets/img/따릉이_Linear.assets/따릉이_Linear_3.png
---
{% raw %}
...
![](/assets/img/따릉이_Linear.assets/따릉이_Linear_0.png){: .align-center}
...
<img src="/assets/img/따릉이_Linear.assets/따릉이_Linear_1.png" alt="스크린샷 2022-04-09 오전 10.43.56" style="zoom:50%;" />
...
![스크린샷 2022-04-09 오후 2.18.44](/assets/img/따릉이_Linear.assets/따릉이_Linear_2.png){: .align-center}
...
![PRP](/assets/img/따릉이_Linear.assets/따릉이_Linear_3.png){: .align-center}
...
![CCPR](/assets/img/따릉이_Linear.assets/따릉이_Linear_4.png){: .align-center}
