...
$$
\bf A\bot_\cal G\bf B\;|\;C \Rightarrow A\bot B\;|\;C
$$
...
$$
p(\mathbf x) = p(x_1,\ldots,x_d) = \prod_{j=1}^d p(x_j|\bf pa\it_j^\cal G\rm)
$$
을 만족하는 것을 의미한다. 이때 우변 곱의 각 인수를 conditional distribution $P_{X_j|\bf PA_\it j^\cal G}$ 의 **causal Markov kernel** 이라고 정의한다.
...
<img src="Causal Inference (6).assets/image-20220803153132412.png" alt="image-20220803153132412" style="zoom:50%;" />

1. 우선 그래프 관계에 의해

$$
X_2\bot X_3|X_1\;\;\text{and}\;\;X_1\bot X_4|X_2,X_3
$$
...
<img src="Causal Inference (6).assets/IMG_BF4ED0EB7667-1.jpeg" alt="IMG_BF4ED0EB7667-1" style="zoom:50%;" />
