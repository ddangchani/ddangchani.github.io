...
![image-20220610194348077](Causal Inference (3).assets/image-20220610194348077.png)
...
$$
편의상 이 경우 $P_{Y|X}$가 ANM을 admit한다고 표기한다(방향성을 condition으로 표기함).
...
$P_{Y|X}$가 X에서 Y로의 smooth ANM을 admit하고, all but countably many인 $x$에 대해
$$
